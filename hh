{
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "exemplar": false,
          "expr": "round(100 - ((node_filesystem_avail_bytes{fstype!=\"rootfs\",mountpoint=\"/\"} * 100) / node_filesystem_size_bytes{fstype!=\"rootfs\",mountpoint=\"/\"}), 0.01) >= 90\r\n",
          "format": "time_series",
          "instant": true,
          "intervalFactor": 1,
          "range": false,
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "((node_memory_MemTotal_bytes{instance=\"$node\", job=\"$job\"} - node_memory_MemAvailable_bytes{instance=\"$node\", job=\"$job\"}) / node_memory_MemTotal_bytes) * 100\r\n",
          "instant": false,
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "(1 - (avg by (instance) (rate(node_cpu_seconds_total{mode=\"idle\", instance=\"$node\", job=\"$job\"}[5m])))) * 100",
          "instant": false,
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
  ...
  "templating": {
    "list": [
      ...
      {
        "current": {
          "text": "10.10.98.20:9100",
          "value": "10.10.98.20:9100"
        },
        "datasource": {
          "type": "prometheus",
          "uid": "${datasource}"
